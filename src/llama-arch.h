...
enum llm_tensor {
    ...
    LLM_TENSOR_RRT_ATTN_QKV_LORA_A,
    LLM_TENSOR_RRT_ATTN_QKV_LORA_B,
    LLM_TENSOR_RRT_ATTN_OUT_LORA_A,
    LLM_TENSOR_RRT_ATTN_OUT_LORA_B,
    LLM_TENSOR_RRT_FFN_GATE_UP_LORA_A,
    LLM_TENSOR_RRT_FFN_GATE_UP_LORA_B,
    LLM_TENSOR_RRT_FFN_DOWN_LORA_A,
    LLM_TENSOR_RRT_FFN_DOWN_LORA_B,
    LLM_TENSOR_RRT_ATTN_NORM,
    LLM_TENSOR_RRT_FFN_NORM,
    LLM_TENSOR_RRT_INDEX_EMBD,
    LLM_TENSOR_RRT_DEEP_RESIDUAL,
