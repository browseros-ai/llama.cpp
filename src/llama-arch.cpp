...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_MOLMO2_RRT_QWEN3, "molmo2-rrt-qwen3" },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_RRT_ATTN_QKV_LORA_A,                    "rrt.%d.%d.attn_qkv_lora_a" },
    { LLM_TENSOR_RRT_ATTN_QKV_LORA_B,                    "rrt.%d.%d.attn_qkv_lora_b" },
    { LLM_TENSOR_RRT_ATTN_OUT_LORA_A,                    "rrt.%d.%d.attn_out_lora_a" },
    { LLM_TENSOR_RRT_ATTN_OUT_LORA_B,                    "rrt.%d.%d.attn_out_lora_b" },
    { LLM_TENSOR_RRT_FFN_GATE_UP_LORA_A,                 "rrt.%d.%d.ffn_gate_up_lora_a" },
    { LLM_TENSOR_RRT_FFN_GATE_UP_LORA_B,                 "rrt.%d.%d.ffn_gate_up_lora_b" },
    { LLM_TENSOR_RRT_FFN_DOWN_LORA_A,                    "rrt.%d.%d.ffn_down_lora_a" },
    { LLM_TENSOR_RRT_FFN_DOWN_LORA_B,                    "rrt.%d.%d.ffn_down_lora_b" },
    { LLM_TENSOR_RRT_ATTN_NORM,                          "rrt.%d.%d.attn_norm" },
    { LLM_TENSOR_RRT_FFN_NORM,                           "rrt.%d.%d.ffn_norm" },
    { LLM_TENSOR_RRT_INDEX_EMBD,                         "rrt.index_embd" },
    { LLM_TENSOR_RRT_DEEP_RESIDUAL,                      "rrt.%d.deep_residual" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_RRT_ATTN_QKV_LORA_A,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_RRT_ATTN_QKV_LORA_B,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_RRT_ATTN_OUT_LORA_A,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_RRT_ATTN_OUT_LORA_B,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_RRT_FFN_GATE_UP_LORA_A,     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_RRT_FFN_GATE_UP_LORA_B,     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_RRT_FFN_DOWN_LORA_A,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_RRT_FFN_DOWN_LORA_B,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_RRT_ATTN_NORM,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_RRT_FFN_NORM,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_RRT_INDEX_EMBD,             {LLM_TENSOR_LAYER_INPUT,     GGML_OP_ADD}},
    {LLM_TENSOR_RRT_DEEP_RESIDUAL,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
